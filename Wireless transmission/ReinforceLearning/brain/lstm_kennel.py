    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            ...
            with tf.variable_scope('l3'):
                ...
                lstm_layer = rnn.BasicLSTMCell(n_l1, forget_bias=1)
                outputs, _ = rnn.static_rnn(lstm_layer, l2, dtype="float32")
                self.q_eval = tf.matmul(outputs[-1], w3) + b3
        ...
        with tf.variable_scope('target_net'):
            ...
            with tf.variable_scope('l3'):
                ...
                lstm_layer = rnn.BasicLSTMCell(n_l1, forget_bias=1)
                outputs, _ = rnn.static_rnn(lstm_layer, l2, dtype="float32")
                self.q_next = tf.matmul(outputs[-1], w3) + b3
